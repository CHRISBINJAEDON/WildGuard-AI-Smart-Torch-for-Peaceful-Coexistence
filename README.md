...
# 🌐 Disaster Alert System (SDAS)

A youth-led, AI-enhanced disaster alert system designed to protect rural and forest-fringe communities from natural hazards. SDAS complements our WildGuard AI Torch by forming a unified safety ecosystem powered by ethical technology.
...
Our team also developed a **Disaster Alert System (SDAS)**, shown in [this video](https://youtu.be/wqNK9tvEdFM), which complements **WildGuard AI** by providing early warnings for natural hazards. Together, these tools form a **youth-led safety ecosystem** for rural communities, combining **AI, IoT, and ethical design**.

SDAS empowers vulnerable regions with real-time alerts for floods, landslides, and extreme weather—helping save lives and build resilience.

---

## 🚨 What It Does

- Detects environmental anomalies (rainfall, vibration, temperature)
- Triggers sirens and LED strobes for local alerts
- Sends mobile notifications via Firebase
- Logs incidents to a cloud dashboard for NGOs and forest departments
- Future upgrades:
  - AI-based anomaly detection
  - Blockchain logging for disaster events
  - Mesh network integration with WildGuard AI
...
### Hardware
- DHT11 / BMP280 sensors (temperature, humidity, pressure)
- Vibration sensor (landslide detection)
- Arduino Nano / ESP32 microcontroller
- Buzzer + LED array (alert system)
- Rechargeable battery (solar-ready)

### Software
- Arduino IDE (firmware)
- Firebase Realtime DB (mobile alerts)
- Node.js + Express (dashboard backend)
- TensorFlow Lite (AI anomaly detection – planned)
- IPFS + Ethereum (blockchain logging – planned)
...
We welcome collaborators in AI, IoT, and disaster resilience. Fork the repo, submit pull requests, or open issues to join our mission.
...
Watch our original field-tested demo:  
[Disaster Alert System – SDAS](https://youtu.be/wqNK9tvEdFM)

This video showcases our working prototype in action, filmed by our team in Tamil Nadu, India.

---

## 🧠 What We Learned

- How to combine sensors, alerts, and cloud systems for real-time safety
- Importance of ethical design and community feedback
- How AI and blockchain can enhance transparency and trust
- Youth innovation can drive scalable impact when aligned with SDGs

---

## 🚀 What’s Next

- AI anomaly detection using TensorFlow Lite
- Blockchain-based disaster logging
- Integration with WildGuard AI for unified safety mesh
- Deployment in disaster-prone villages across India
